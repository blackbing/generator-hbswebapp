...
AppGenerator.prototype.requirejs = function requirejs() {
  if (this.includeRequireJS) {
    ...
    this.mainJsFile = [
      ...
      (this.includeHBS)?'        helperPathCallback: (name) ->  # Callback to determine the path to look for helpers':'',
      (this.includeHBS)?'           "templates/helpers/" + name # ("/template/helpers/"+name by default)':'',
